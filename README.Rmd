...
In the future, it should also be possible to create sunburst graphs via [`{highcharter}`].
See https://www.highcharts.com/demo/sunburst for an example.
...
knitr::include_graphics('man/figures/sunburst.png', dpi = 150)
```
